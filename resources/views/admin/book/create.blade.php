                ...
                <form action="{{route('books.store')}}" method="post" class="w-full h-full flex flex-row-reverse">
                    ...
                    <div class="w-[45%] h-full flex flex-col items-end pr-20 relative">
                        ...
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="text" name="ISBN" value="{{old('ISBN')}}" id="ISBN" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @error('ISBN')
                                <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="number" name="publishedYear" min="1990" max="2026" value="{{old('publishedYear')}}" id="publishedYear" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @error('publishedYear')
                            <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="number" name="pageCount" min="1" max="1000" value="{{old('pageCount')}}" id="pageCount" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @error('pageCount')
                            <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="w-[55%] h-full flex flex-col items-end pr-10">
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <textarea name="summary" id="summary" cols="10" rows="10" class="w-2/5 h-28 rounded outline-0 p-2 border border-gray-400">{{old('summary')}}</textarea>
                            @error('summary')
                            <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="number" name="price" min="10" max="20000" value="{{old('price')}}" id="price" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @error('price')
                            <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="number" name="stock" min="0" max="200" value="{{old('stock')}}" id="stock" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @error('stock')
                            <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
